...
function App({ initialWorkouts = [], stravaPRs = [], stravaActivities = [], garminHealth = [], archiveWorkouts = [], gymTemplates = [], gymSessions = [], gymWeights = [], customExercises = [], mealPlans = [], mealCompletions = [] }) {
